...
import com.example.android.contentprovidersample.data.CheseeViewModel;
...
//        CheseeViewModel mCheeseViewModel = new ViewModelProvider(this).get(CheseeViewModel.class);
//        mCheeseViewModel.getAllCheese().observe(this, new Observer<List<Cheese>>() {
//            @Override
//            public void onChanged(List<Cheese> mCheese) {
//                mCheeseAdapter.setCheeses((Cursor) mCheese);
//            }
//        });
    }
...
//            if (mCursor != null) {
//                if (mCursor.moveToPosition(position)) {
//                    Cheese current = mCursor.get(position);
//                    holder.mText.setText(current.getTask());
//                }
//
//            } else {
